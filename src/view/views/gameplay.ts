...
import { GlassOfLemonade } from "../../entity/tools/glassoflemonade.js";
...
bar.addElement( new SpawnButton("use-honey", JarOfHoney));
bar.addElement( new SpawnButton("use-lemonade", GlassOfLemonade));
bar.addElement( new SpawnButton("use-toothpick", Toothpick));
