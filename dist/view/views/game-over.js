...
view.addElement(new ViewSprite("paper-big")
    .setAnchor(Engine.anchorPresets.centerCenter)
    .setOrigin(0.5, 0.5)
    .setRotation(7, "deg"), new ViewText("Game Over!")
    .setAnchor(Engine.anchorPresets.centerCenter)
    .setTranslation(0, -120)
    .setAlignment("center", "bottom")
    .setFont("Preahvihear", 90)
    .setFill("black")
    .setStroke("none"), new ViewText("☞ you got to wave 0 ☜")
    .setAnchor(Engine.anchorPresets.centerCenter)
    .setTranslation(0, -70)
    .setAlignment("center", "bottom")
    ...
    .setAnchor(Engine.anchorPresets.centerCenter)
    .setOrigin(0.5, 0.5)
    .setRotation(-3, "deg"), new ViewText("> main menu <")
    .setAnchor(Engine.anchorPresets.centerCenter)
